...
if (navigator.userAgent.indexOf("Chrome") != -1) {
  downloadLink.innerHTML = "Add to Chrome";
  downloadLink.href = "https://chrome.google.com/webstore/detail/adcause/mnnfmimckmnmceicekhipnmlijfoamkn?hl=en";
}
else if (navigator.userAgent.indexOf("Firefox") != -1) {
  downloadLink.innerHTML = "Add to Firefox";
		...
		if (hasCounters) {
			...
			var waypoint = new Waypoint({
			  ...
			  handler: function() {
					...
					// Counter 1
					var counter1 = new CountUp('count-1', 0, 59, 0, 10, options);
					counter1.start();
					// Counter 2
		...
		if (hasCounters) {
			...
			var waypoint = new Waypoint({
			  ...
			  handler: function() {
					...
					// Counter 1
					var counter1 = new CountUp('count-min-1', 0, 20, 0, 3, options);
					counter1.start();
					// Counter 2
